...
@Slf4j
@Singleton
public class FromScratchUnlockedItemsDataProvider extends AbstractDataProvider {
            ...
            public void onUpdate(Integer key, UnlockedItem newUnlockedItem) {
                ...
                for (UnlockedItemsMapListener listener : unlockedItemsMapListeners) {
                    try {
                        ...
                        log.error("fromScratch unlockedItemUpdateListener: onUpdate", ex);
                    }
                }
            }
            ...
            public void onDelete(Integer key) {
                ...
                for (UnlockedItemsMapListener listener : unlockedItemsMapListeners) {
                    try {
                        ...
                        log.error("fromScratch unlockedItemDeleteListener: onDelete", ex);
                    }
                }
            }
        };
    ...
    protected void onRemoteStorageReady() {
        keyValueStoragePort = remoteStorageService.getFromScratchUnlockedItemsStoragePort();
    ...
    public CompletableFuture<Void> clearAll() {
        ...
        unlockedItemsMap.clear();
        return keyValueStoragePort.updateAll(Collections.emptyMap());
    }
